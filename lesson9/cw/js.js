...
//     a.innerHTML=`${simpson.name} ${simpson.surname} ${simpson.age} ${simpson.info} ${simpson.photo}`
...
//     h1.innerHTML=simpson.name;
//     let h2=document.createElement('h2');
//     h2.classList.add('surname');
//     h2.innerHTML=simpson.surname;
...
for (const item of coursesArray) {
    ...
    duration.style.columnGap='40px';
    duration.style.display='flex';
    duration.style.justifyContent='center';
    duration.style.fontSize='30px';
