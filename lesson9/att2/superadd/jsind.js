...
//     user1.append(name,age,status,address)
...
// content.append(ul);
// for (const contentElement of h2) {
//     let v=document.createElement('li');
//     v.innerHTML=contentElement.innerHTML
//     ul.append(v)
// }
...
for (const rule of rules) {
    ...
    document.body.append(rule1);
    rule1.append(title,body);
